...
<div class="left-side-bar">
	<div class="brand-logo">
		<a href="index_admin.php">
			<img src="./assets/vendor/images/deskapp-logo.svg" alt="" class="dark-logo" />
		...
		<div class="sidebar-menu">
			<ul id="accordion-menu">
				...
				<li class="dropdown">
					...
					<ul class="submenu">
						<li><a href="all_konten.php">Konten Artikel dan Berita</a></li>
					</ul>
				</li>
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">
									<a href="data_berita.php"> Konten Artikel dan Berita</a>
								</li>
			...
			<div class="pb-20">
				...
				<tbody>
					...
					foreach($hasil as $data){
						...
						<tr>
							<td class="table-plus text-center"><?php echo $data['id'] ?></td>
							<td class="text-center"><?php echo $data['tanggal'] ?></td>
							<td class="text-center"><?php echo $data['kategori'] ?></td>
							<td class="text-justify"><?php echo $data['judul'] ?></td>
