...
<div class="main-container">
	<div class="pd-ltr-20 xs-pd-20-10">
		...
		<div class="pd-20 card-box mb-30">
			<div class="clearfix">
				<div class="pull-left">
					...
					<p class="mb-30">Tambahkan Data Admin Baru</p>
				</div>
			...
			<form method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-12 col-md-10">
						...
						type="text"
						name="address"
						placeholder="Jalan Indonesia No. 45"
						data-validate = "Data is required"
						/>
					</div>
				</div>
		...
		if (isset($_POST['tambah'])) {
			$query = $conn->prepare("INSERT INTO users(full_name, email, password, phone, address) VALUES(
				'" . $_POST['full_name'] . "', '" . $_POST['email'] . "', '" . $_POST['password'] . "', '" . $_POST['phone'] . "', '" . $_POST['address'] . "'
			)");
