				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 text-right">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="tambah_admin.php">Tambah Data User</a>
						</div>
					</div>
				</div>
				...
				<tbody>
					...
					foreach($hasil as $data){
						...
						<tr>
							...
							<td>
								<a href="update_admin.php?id=<?php echo $data['id']; ?>">Update</a> |
								<a href="delete_admin.php?id=<?php echo $data['id']; ?>">Delete</a>
							</td>
						</tr>
					<?php } ?>
				</tbody>
